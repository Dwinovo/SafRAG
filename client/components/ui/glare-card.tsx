...
export const GlareCard = ({
  ...
  return (
    <div
      ...
      className={cn(
        'relative isolate [contain:layout_style] [perspective:600px] transition-transform duration-[var(--duration)] ease-[var(--easing)] delay-[var(--delay)] will-change-transform w-[280px] max-w-full [aspect-ratio:17/21]',
        containerClassName
      )}
      ref={refElement}
      onPointerMove={(event) => {
